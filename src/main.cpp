...
unsigned int nTargetSpacing = 10 * 60; // WorldCupCoin - 10 minute blocks
static const int64_t nInterval = nTargetTimespan / nTargetSpacing;
static const int64_t nDiffChangeTarget = 1;

unsigned int nStakeMinAge = 8 * 60 * 60; // 8 hours
unsigned int nStakeMaxAge = -1;
unsigned int nModifierInterval = 10 * 60; // WorldCupCoin - time to elapse before new modifier is computed
...
static const int g_RewardHalvingPeriod = 275000;
...
bool CBlock::AcceptBlock()
{
    ...
    //disabled pos, can be turned on later
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "WorldCupCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Coindesk June 15, 2015 - MovieTickets.com Brings Bitcoin to Over 900 US Movie Theaters";
        CTransaction txNew;
        txNew.nTime = 1481215478;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
       ...
       if (true && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("708d73f8e96c5d39dfcd50a1330ec8530d71191bc42312461b0c80d8a68f7b16"));
    ...
    string strPubKey = "";
