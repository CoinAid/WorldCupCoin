...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("WorldCupCoin-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("WorldCupCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "WorldCupCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("WorldCupCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("WorldCupCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("WorldCupCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("WorldCupCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. WorldCupCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("WorldCupCoin-start");
