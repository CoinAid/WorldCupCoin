...
{
    return GetBoolArg("-testnet", false) ? 54832 : 54833;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop WorldCupCoin server (and possibly override the detachdb config value).");
...
void ThreadRPCServer(void* parg)
{
    ...
    RenameThread("WorldCupCoin-rpclist");
...
void ThreadRPCServer3(void* parg)
{
    ...
    RenameThread("WorldCupCoin-rpchand");
